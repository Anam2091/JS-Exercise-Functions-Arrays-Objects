...
function getName(variable) {
  return `Hello, my name is ${variable.name}`
}
...
*/
function getLastCarInfo(array3) {
  return getCarInfoByIndex(array3, 49) 
}
...
*/
function getModelYears(array5) {
  let caryear = []
for(let i=0; i<array5.length; i++){
  caryear.push(array5[i].car_year)
